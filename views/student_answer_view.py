...
@bp_answer.route("/findByActivityAndStudentId/<int:id_activity>/<int:id_student>", methods=["GET"])
...
@bp_answer.route("/findByQuestionAndStudentId/<int:id_question>/<int:id_student>", methods=["GET"])
...
@bp_answer.route("/delete/<int:id_answer>", methods=["DELETE"])
